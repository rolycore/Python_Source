...
output = four_point_transform(imagen, displayCnt.reshape(4, 2))
...
cv2.imshow("original4", imagen)
cv2.imshow("recortado4", output)
cv2.imshow("ventana5", thresh)
